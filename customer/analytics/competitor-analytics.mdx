...
Every chart and card in the Competitors view is clickable. Selecting a bar segment, competitor row, or market opportunity card opens the **Insights drilldown** — a filtered list of the individual field insights behind that data point.

The drilldown automatically carries context from the chart you clicked. For example, clicking a competitor's bar in the objections chart opens insights pre-filtered to that competitor and objection type. Clicking a market opportunity card shows the insights that triggered that opportunity.

Once in the drilldown, you can refine results further with the filter bar at the top of the page:

| Filter | Effect |
|--------|--------|
| **Competitor** | Show only insights mentioning a specific competitor |
| **Customer** | Narrow to insights for a specific account |
| **Insight type** | Filter by the type of insight (e.g. objection, sourcing, switching) |
