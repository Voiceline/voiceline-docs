...
Competitor mentions are classified as **matched** (linked to a competitor on your list) or **unmatched** (detected as a competitive reference but not linked to any configured competitor). The dashboard shows both categories so you can track known competitors and discover new ones your reps are encountering in the field.

When you spot an unmatched mention appearing frequently, you can match it to an existing competitor or add a new one under **Workspace Settings** → **Data Objects** → **Competitors**.
