---
title: "Contacts"
description: "Understand how contact records sync from your CRM to VoiceLine and how reps reference them in call logs, meetings, and leads."
status: Live
...
Yes — via voice or business card scan. VoiceLine checks for duplicates before creating. See [Contact Creation](/customer/productivity/customer-data-quality/contact-creation).
...
Visibility is controlled by [Search Settings](/customer/platform/search-settings) permission configuration.
