---
title: "Meetings"
description: "Learn how reps schedule follow-up appointments via voice and how VoiceLine pushes them to your CRM and attendee calendars."
status: Live
...
A [Reminder](/customer/productivity/workflows/reminder) creates a personal calendar entry in the rep's email client — no CRM record, no attendees. A Meeting creates a CRM appointment and sends invites to all listed attendees.
