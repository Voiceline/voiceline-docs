---
title: "Tasks"
description: "Learn how reps create structured follow-up actions via voice and how VoiceLine syncs them to your CRM as task records."
status: Live
...
A [Reminder](/customer/productivity/workflows/reminder) creates a personal calendar entry for the rep only — no CRM record, not assignable to others. A Task syncs to the CRM and can be assigned to any team member.
