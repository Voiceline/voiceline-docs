---
title: "Accounts"
description: "Understand how account records sync from your CRM to VoiceLine and how reps use them as the anchor for field activities."
status: Live
...
Admins can control which accounts are visible to which rep groups via permission settings — see [Search Settings](/customer/platform/search-settings).
...
Search can also match on customer number or city, depending on your [Search Settings](/customer/platform/search-settings) configuration.

## FAQ

**Can reps create new accounts?**
Yes — reps can create new accounts via voice. VoiceLine runs a deduplication check before creation to prevent duplicates. See [Account Creation](/customer/productivity/customer-data-quality/account-creation).
