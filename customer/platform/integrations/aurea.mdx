---
title: "Aurea CRM"
description: "Connect VoiceLine to Aurea CRM using Basic authentication to sync account activity history and push outbound field activity records."
status: Live
...
- Network access to your Aurea instance (VPN may be required — see [Integrations](/customer/platform/integrations/index#network-requirements))
