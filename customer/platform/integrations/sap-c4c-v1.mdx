---
title: "SAP Cloud for Customer (v1)"
...
<Note>VoiceLine requires a dedicated service user account in SAP C4C, not an individual rep's login credentials. The service user must have OData API permissions for the objects listed above.</Note>
