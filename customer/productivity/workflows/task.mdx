...
<Note>Task fields, CRM mapping, and delegation options are configured during your VoiceLine implementation. See [Task Standard Implementation](/implementation/standard-implementations/task) for the default configuration, or [Product Customisation](/implementation/product-customisation) for what can be adjusted.</Note>
