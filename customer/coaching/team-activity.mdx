...
Open **Visit Feed** from the sidebar to see a table of recent visit reports from your team. The table is sortable and filterable by team member, customer, outcomes, insight categories, date range, and group. Click any row to read the full report, including the AI-generated summary, contacts mentioned, and follow-up actions created.

For analytics layered on top of visit content — visit performance metrics, richness scoring, and the full Visit Feed with filters — see [Visit Analytics](/customer/coaching/visit-analytics).
