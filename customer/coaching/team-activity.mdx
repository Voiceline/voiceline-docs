---
title: "Team Activity"
description: "See what every rep on your team did today — visits, calls, opportunities, leads — without reading a single report."
status: Live
bundles:
...
For analytics layered on top of visit content — visit performance metrics, richness scoring, and the Visit Insight Feed with search — see [Visit Analytics](/customer/coaching/visit-analytics).
