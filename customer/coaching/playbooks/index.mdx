...
Playbooks are designed to collect information that emerges during the visit itself. Questions about what a rep researched beforehand, or one-time account facts like the current supplier, tend to feel out of place mid-visit and get repetitive over multiple calls. See [Playbook Builder](/customer/coaching/playbooks/builder) for guidance on framing questions correctly.
